...
#include "modules/neuro/pipelines/neurodemo.h"
#include "modules/neuro/pipelines/viscontestdemo.h"
...
namespace campvis {
    ...
    template class SmartProcessorRegistrar<neuro::MultiVolumeMprRenderer>;
    template class SmartProcessorRegistrar<neuro::MultiVolumeRaycaster>;
