...
#ifndef GLINTENSITYQUANTIZER_H__
#define GLINTENSITYQUANTIZER_H__
...
namespace campvis {
    ...
    public:
        ...
        IntProperty p_numberOfBins;         ///< Number of bins in output image
        TransferFunctionProperty p_transferFunction;    ///< Transfer function to apply befor quantizing
