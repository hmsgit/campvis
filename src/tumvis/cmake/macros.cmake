...
MACRO(COPY_EXTERNAL_DLLS DebugDLLs ReleaseDLLs failOnError)
    ...
    SET(debug_dir "${TUMVIS_HOME}/bin/Debug")
    ...
    SET(release_dir "${TUMVIS_HOME}/bin/Release")
...
MACRO(ADD_COPY_DLL_COMMAND Target DebugDLLs ReleaseDLLs)
    ...
    FOREACH(dll ${${DebugDLLs}})
        ...
        ADD_CUSTOM_COMMAND(
            TARGET ${Target}
            COMMAND ${CMAKE_COMMAND} -E copy ${dll} ${TUMVIS_HOME}/bin/Debug
        )
    ENDFOREACH()
    FOREACH(dll ${${ReleaseDLLs}})
        ADD_CUSTOM_COMMAND(
            TARGET ${Target}
            COMMAND ${CMAKE_COMMAND} -E copy ${dll} ${TUMVIS_HOME}/bin/Release
        )
    ENDFOREACH()
